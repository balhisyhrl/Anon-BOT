...
END:VCARD`.trim()
    ...
    */
    ...
    conn.sendButtonDoc = async (jid, content, footerText, button1, id1, quoted, options) => {
      ...
      const buttonMessage = {
        document: { url: "https://wa.me/6285156299020" },
        mimetype: global.doc,
      ...
      conn.sendMessage(jid, buttonMessage, { quoted, ephemeralExpiration: global.ephemeral, forwardingScore: 99999, isForwarded: false, ...options })
    }
    conn.send2ButtonDoc = async (jid, content, footerText, button1, id1, button2, id2, quoted, options) => {
        ...
        conn.sendMessage(jid, buttonMessage, { quoted, ephemeralExpiration: global.ephemeral, contextInfo: { mentionedJid: conn.parseMention(content + footerText), forwardingScore: 99999, isForwarded: false }, ...options, ephemeralExpiration: global.ephemeral } )
    }
    ...
    conn.sendButton = async (jid, content, footerText, button1, id1, quoted, options) => {
        ...
        conn.sendMessage(jid, buttonMessage, { quoted, ephemeralExpiration: global.ephemeral, contextInfo: { mentionedJid: conn.parseMention(content + footerText), forwardingScore: 999999, isForwarded: false }, ...options })
    }
    ...
    conn.send3Button = async (jid, content, footerText, button1, id1, button2, id2, button3, id3, quoted, options) => {
        ...
        conn.sendMessage(jid, buttonMessage, { quoted, ephemeralExpiration: global.ephemeral, contextInfo: { mentions: conn.parseMention(content + footerText), forwardingScore: 99999, isForwarded: false }, ...options })
    }
    ...
    */
    conn.send3TemplateButtonImg = async (jid, buffer, content, footerText, button1, id1, button2, id2, button3, id3, quoted, options) => {
        ...
        const buttons = [
            ...
            { index: 2, urlButton: { displayText: gcbot, url: gcurl } },
    ...
    conn.sendTemplateButtonFakeImg = async (jid, buffer, content, footerText, btn1, id1, options) => {
        ...
        conn.sendMessage(jid, key, { ephemeralExpiration: global.ephemeral, mentions: conn.parseMention(content + footerText), contextInfo: { forwardingScore: 99999, isForwarded: false }, ...options })
    }
    conn.send2TemplateButtonFakeImg = async (jid, buffer, content, footerText, btn1, id1, btn2, id2, quoted, options) => {
        ...
        conn.sendMessage(jid, key, { quoted, ephemeralExpiration: global.ephemeral, contextInfo: { mentions: conn.parseMention(content + footerText), forwardingScore: 9999, isForwarded: false } })
    }
    conn.send3TemplateButtonFakeImg = async (jid, buffer, content, footerText, btn1, id1, btn2, id2, btn3, id3, quoted, options) => {
        ...
        conn.sendMessage(jid, key, { quoted, ephemeralExpiration: global.ephemeral, contextInfo: { forwardingScore: 9999, isForwarded: false, mentions: conn.parseMention(content) } })
    }
    ...
    */
    ...
    conn.downloadAndSaveMediaMessage = async (message, filename, attachExtension = true) => {
        ...
        // save to file
        await fs.writeFileSync(`./tmp/`+trueFileName, buffer)
        return trueFileName
    }
